...
int main (void) {
  ...
  BUTTON_init();												/* BUTTON Initialization              */
	...
	init_timer(3,25000000);							/* 25MHz * 1s = 25000000			*/
	
	init_timer(2,25000000);							/* 25MHz * 1s = 25000000 -> timer che conterà il tempo delle variazioni*/
	
	init_timer(1,0x02FAF080);						/* 25MHz * 1/0.5Hz = 25Mhz * 2[s] = 0x02FAF080*/
