...
//	 <i> 0 Feature disabled.
//   </e>
	LPC_TIM0->MCR = 3;				/* 3: Interrupt and Reset with period of 0.9s */
// </h>
//*** <<< end of configuration section >>>    ***
  ...
  else if ( timer_num == 1 )
  {
	...
	LPC_TIM1->MCR = 3;				/* 3: Interrupt and Reset with period of 1.3s */
	...
	else if ( timer_num == 2 )
  {
	...
	LPC_TIM2->MCR = 7;				/* 7: Interrupt and Reset and Stop on MR1 */
