...
int main (void) {
  ...
  BUTTON_init();												/* BUTTON Initialization              */
	...
	//init e enable allo start di timer 3, timer ciclico senza interrupt con periodo di 1.22 min 
	init_timer(3,0x6D139580);							/* 25MHz * 1,22*60s	= 6D139580				*/
	enable_timer(3);
	
	init_timer(2, 0x00E4E1C0);			//init timer 2 ciclico con interrupt di 600ms (25MHz * 0.6s = E4E1C0)
